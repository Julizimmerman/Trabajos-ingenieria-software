...
holdsS :: Stack -> Palet -> Bool
holdsS (Sta [] _) _ = True  -- Si la pila está vacía, podemos apilar cualquier palet
holdsS (Sta (headPalet : _) _) palet = destinationP palet == destinationP headPalet  -- Verifica el orden
